                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="flex p-4 s">
                            <a href="{{ route('penugasan') }}"
                                ...
                                <!-- Icon (optional, replace with your preferred SVG) -->
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2">
                                ...
                                <li class="p-4 bg-green-50 rounded-lg shadow-sm flex items-center justify-between space-x-4">
                                    <div class="flex-1">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <p class="text-gray-600 mt-1"><strong>Nilai:</strong> {{ $mahasiswa->Nilai ?? 'Belum Dinilai' }}</p>
                                        <!-- Form for updating Nilai -->
                                        <form action="{{ route('QCupdateNilai', ['id_tugas' => $mahasiswa->ID_Tugas, 'nim' => $mahasiswa->Mahasiswa_NIM]) }}"
                                            method="POST"
                                            class="flex items-center space-x-2">
                                            @csrf
                                            @method('PUT') <!-- Laravel's way of supporting PUT method -->
                                            <input
                                                type="number"
                                                name="nilai"
